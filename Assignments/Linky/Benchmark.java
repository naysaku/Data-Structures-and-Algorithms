...
public class Benchmark {
    ...
    private static final String OUTPUT_FILE = "benchmark_results2.txt";
    ...
    public static void main(String[] args) {
        ...
        // Print and write sizes
        printAndWrite(sizesBuilder.toString());

        // Print and write array times
        printAndWrite(arrayAppendBuilder.toString());

        // Print and write linked list times
        printAndWrite(linkedListAppendBuilder.toString());

    }

    private static void printAndWrite(String content) {
